...
.DESCRIPTION
    ...
    required, but very useful for baselines.  Be aware, though, that
...
# Save hashes and full paths to the baseline files to a CSV:
...
# Write to the event log about the baseline process?  (write-eventlog)  
