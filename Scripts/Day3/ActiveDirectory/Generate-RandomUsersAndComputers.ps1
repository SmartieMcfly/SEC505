################################################################################
#.SYNOPSIS
#   Generate realistic-looking random user and computer accounts in AD.
#
#.DESCRIPTION
#   Creates random user and/or computer accounts in Active Directory 
...
#  Version: 1.0
#   Author: Jason Fossen (https://BlueTeamPowerShell.com)
